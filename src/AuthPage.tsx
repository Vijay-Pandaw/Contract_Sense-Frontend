          ...
          <div className="auth-card-inner">
            ...
            {mode === 'login' && (
              <form className="auth-form-body" onSubmit={handleLogin}>
                ...
                <button type="submit" className="button button-coral auth-login-signup-btn w-full py-3.5 text-base font-bold rounded-lg shadow-[0_0_20px_rgba(124,58,237,0.4)] hover:-translate-y-0.5 hover:shadow-[0_0_30px_rgba(124,58,237,0.6)] transition-all flex items-center justify-center gap-2" disabled={submitting}>
